  ...
  ngOnInit() {
    ...
    this.projectsService.GetProyectos().subscribe(data => {
      ...
      for(let i = 0; i < Object.values(data).length; i++) {
        status = Number(Object.values(Object.values(Object.values(data))[i])[5]);
        if(status==1) {
          this.proyectos[index] = {
            id_proyecto: Number(Object.values(Object.values(Object.values(data))[i])[0]),
            nombre: Object.values(Object.values(Object.values(data))[i])[1].toString(),
            descripcion: Object.values(Object.values(Object.values(data))[i])[2].toString(),
    ...
    this.employeeService.GetEmpleados().subscribe(data => {
      let status: number = 0, index: number = 0;
      for(let i = 0; i < Object.values(data).length; i++) {
        status = Number(Object.values(Object.values(Object.values(data))[i])[6]);
        if(status==1) {
          this.empleados[index] = {
            id_empleado: Number(Object.values(Object.values(Object.values(data))[i])[0]), 
            nombre: Object.values(Object.values(Object.values(data))[i])[1].toString(),
            apellido: Object.values(Object.values(Object.values(data))[i])[2].toString(),
            direccion: Object.values(Object.values(Object.values(data))[i])[3].toString(), 
            telefono: Object.values(Object.values(Object.values(data))[i])[4].toString(),
            sueldo: Number(Object.values(Object.values(Object.values(data))[0])[5]),
            status: Number(Object.values(Object.values(Object.values(data))[0])[6])
          };
          index++;
        }
      }
