...
namespace ASPNETCoreWebApiPeliculas.Controllers
{
    ...
    public class DescargasController : ControllerBase
    {
        ...
        //POST: https://192.168.1.68:443/Api/Descargas/CrearTipoArchivo
        ...
        //GET: https://192.168.1.68:443/Api/Descargas/GetTiposArchivo
        [HttpGet] [ActionName("GetTiposArchivo")]
        public async Task<Object []> GetFileTypesAsync() {
            return await descargas.GetTiposArchivo();
        }

        //PUT: https://192.168.1.68:443/Api/Descargas/ActualizarTipoArchivo
        ...
        //DELETE: https://192.168.1.68:443/Api/Descargas/EliminarTipoArchivo?id_tipo_archivo=[value]
        ...
        //POST: https://192.168.1.68:443/Api/Descargas/CrearServidor
        ...
        //GET: https://192.168.1.68:443/Api/Descargas/GetServidores
        [HttpGet] [ActionName("GetServidores")]
        public async Task<Object []> GetServersAsync() {
            return await descargas.GetServidores();
        }

        //PUT: https://192.168.1.68:443/Api/Descargas/ActualizarServidor
        ...
        //DELETE: https://192.168.1.68:443/Api/Descargas/EliminarServidor?id_servidor=[value]
        ...
        public async Task<Object []> DeleteServerAsync(int id_servidor) {
         ...
         //POST: https://192.168.1.68:443/Api/Descargas/CrearDescarga
        ...
        //GET: https://192.168.1.68:443/Api/Descargas/GetDescargas
        [HttpGet] [ActionName("GetDescargas")]
        public async Task<Object []> GetDownloadsAsync() {
            return await descargas.GetDescargas();
        }

        //PUT: https://192.168.1.68:443/Api/Descargas/ActualizarDescarga
        ...
        //DELETE: https://192.168.1.68:443/Api/Descargas/EliminarDescarga?id_descarga=[value]
        ...
        //POST: https://192.168.1.68:443/Api/Descargas/CrearEnlace
        ...
        //GET: https://192.168.1.68:443/Api/Descargas/GetEnlacesDescarga?id_descarga=[value]
        ...
        //PUT: https://192.168.1.68:443/Api/Descargas/ActualizarEnlace
        ...
        //DELETE: https://192.168.1.68:443/Api/Descargas/EliminarEnlace?id_enlace=[value]
