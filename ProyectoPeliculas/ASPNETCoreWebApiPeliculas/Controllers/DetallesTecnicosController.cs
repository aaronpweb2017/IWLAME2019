...
namespace ASPNETCoreWebApiPeliculas.Controllers
{
    ...
    public class DetallesTecnicosController : ControllerBase
    {
        ...
        //POST: https://192.168.1.68:443/Api/DetallesTecnicos/CrearFormato
        ...
        //GET: https://192.168.1.68:443/Api/DetallesTecnicos/GetFormatos
        [HttpGet] [ActionName("GetFormatos")]
        public async Task<Object []> GetFormatsAsync() {
            return await detallesTecnicos.GetFormatos();
        }

        //PUT: https://192.168.1.68:443/Api/DetallesTecnicos/ActualizarFormato
        ...
        //DELETE: https://192.168.1.68:443/Api/DetallesTecnicos/EliminarFormato?id_formato=[value]
        ...
        //POST: https://192.168.1.68:443/Api/DetallesTecnicos/CrearTipoResolucion
        ...
        //GET: https://192.168.1.68:443/Api/DetallesTecnicos/GetTiposResolucion
        ...
        //PUT: https://192.168.1.68:443/Api/DetallesTecnicos/ActualizarTipoResolucion
        ...
        //DELETE: https://192.168.1.68:443/Api/DetallesTecnicos/EliminarTipoResolucion?id_tipo_resolucion=[value]
        ...
        //POST: https://192.168.1.68:443/Api/DetallesTecnicos/CrearValorResolucion
        ...
        //GET: https://192.168.1.68:443/Api/DetallesTecnicos/GetValoresResolucion
        ...
        //PUT: https://192.168.1.68:443/Api/DetallesTecnicos/ActualizarValorResolucion
        ...
        //DELETE: https://192.168.1.68:443/Api/DetallesTecnicos/EliminarValorResolucion?id_valor_resolucion=[value]
        ...
        //POST: https://192.168.1.68:443/Api/DetallesTecnicos/CrearRelacionAspecto
        ...
        //GET: https://192.168.1.68:443/Api/DetallesTecnicos/GetRelacionesAspecto
        ...
        //PUT: https://192.168.1.68:443/Api/DetallesTecnicos/ActualizarRelacionAspecto
        ...
        //DELETE: https://192.168.1.68:443/Api/DetallesTecnicos/EliminarRelacionAspecto?id_relacion_aspecto=[value]
        ...
        //POST: https://192.168.1.68:443/Api/DetallesTecnicos/CrearResolucion
        ...
        //DELETE: https://192.168.1.68:443/Api/DetallesTecnicos/EliminarResolucion?id_tipo_resolucion=[value]&id_valor_resolucion=[value]&id_relacion_aspecto=[value]
        ...
        //POST: https://192.168.1.68:443/Api/DetallesTecnicos/CrearDetalleTecnico
        ...
        //PUT: https://192.168.1.68:443/Api/DetallesTecnicos/ActualizarDetalleTecnico
        ...
        //DELETE: https://192.168.1.68:443/Api/DetallesTecnicos/EliminarDetalleTecnico?id_detalle=[value]
