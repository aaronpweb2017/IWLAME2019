...
namespace ASPNETCoreWebApiPeliculas.Services
{
    ...
    public class UserService : IUserService {
        ...
        // private readonly EntityFrameworkContext EFCoreContext;

        // public UserService(IOptions<AppSettings> appSettings, EntityFrameworkContext EFCoreContext) {
        ...
        //     Usuario user = EFCoreContext.usuarios.Where(usuario => usuario.correo_usuario == userNameEmail
        ...
        //     }
        //     UsuarioSolicitud request = EFCoreContext.usuariosSolicitudes.
        ...
        //     Usuario UpdatedUser = EFCoreContext.usuarios.FindAsync(user.id_usuario).Result;        
        ...
        //         EFCoreContext.Update(request);
        //         EFCoreContext.SaveChangesAsync(); 
        //     }
        //     EFCoreContext.Update(UpdatedUser);
        //     EFCoreContext.SaveChangesAsync();
