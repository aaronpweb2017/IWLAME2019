...
export class DetallesTecnicosService {
  ...
  getFormatos(): Observable<Formato[]> {
    ...
    ).pipe(map((data: any) => data as Formato[]));
  }
  ...
  getTiposResolucion(): Observable<TipoResolucion[]> {
    ...
    ).pipe(map((data: any) => data as TipoResolucion[]));
  }
  ...
  getValoresResolucion(): Observable<ValorResolucion[]> {
    ...
    ).pipe(map((data: any) => data as ValorResolucion[]));
  }
  ...
  getRelacionesAspecto(): Observable<RelacionAspecto[]> {
    ...
    ).pipe(map((data: any) => data as RelacionAspecto[]));
  }
  ...
  eliminarResolucion(id_tipo_resolucion: number, id_valor_resolucion: number, id_relacion_aspecto: number): Observable<boolean> {
