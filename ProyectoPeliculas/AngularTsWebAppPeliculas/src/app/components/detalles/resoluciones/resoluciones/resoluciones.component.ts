...
export class ResolucionesComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.vistasService.getResolucionesVista().subscribe(resoluciones => {
      ...
      this.detallesTecnicosService.getTiposResolucion().subscribe(tiposResolucion => { this.tiposResolucion = tiposResolucion;});
      this.detallesTecnicosService.getValoresResolucion().subscribe(valoresResolucion => { this.valoresResolucion = valoresResolucion; });
      this.detallesTecnicosService.getRelacionesAspecto().subscribe(relacionesAspecto => { this.relacionesAspecto = relacionesAspecto; });
    });
  }
